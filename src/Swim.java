...
public class Swim {
	//Variables
		...
		public void driver(Input i) //data type is Input 
		{
			...
			getTime(); 
			calcCalories(); 
			JOptionPane.showMessageDialog(null, "Time swimming: " + time + " minutes and calories consumed: " + calories);
		}
		...
		{
			String t = JOptionPane.showInputDialog("Enter the time in minutes you spent swimming: ");
